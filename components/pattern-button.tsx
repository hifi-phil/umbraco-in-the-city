...
export default function PatternButton({ children, onClick, className = "", disabled = false }: PatternButtonProps) {
  return (
    <div className={`relative inline-block ${className}`}>
      ...
      >
        {/* Left side pattern */}
        <div className={`absolute left-0 top-0 ${disabled ? 'opacity-50' : ''}`}>
          <Image
